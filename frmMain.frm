...
Begin VB.Form frmHeroes 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(1)   =   "frmMain.frx":128E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtEffect"
      Tab(1).Control(1)=   "lstSpecials"
      Tab(1).Control(2)=   "lblOPD"
      Tab(1).Control(3)=   "lblCode"
      Tab(1).Control(4)=   "lblSpecials"
      Tab(1).Control(5)=   "imgSpecial"
